...
**Задача 3: Закрыть topic 25 — минимум 5–8 записей**
...
**Задача 4: Усилить покрытие topics 22–24 (цель: 5–10 записей на тему)**
...
**Задача 5: Исправить `type.replace('_', '-')` в DictionaryEntryCard**
